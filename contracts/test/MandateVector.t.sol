...
contract MandateVectorTest {
    ...
    function testBothEnvelopes() public pure {
        ...
        hashes[1] = b;
        bytes32 header0 =
            bytes32(abi.encodePacked(bytes9(0x796479647964796479), bytes1(0x03), uint16(0), V.APPLICATION));
        bytes32 header1 =
            bytes32(abi.encodePacked(bytes9(0x796479647964796479), bytes1(0x03), uint16(1), V.APPLICATION));
